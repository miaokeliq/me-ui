...
{
  // 动态生成一个按钮
  var Constructor = _vue.default.extend(_button5.default); //使用基础 Vue 构造器，创建一个“子类”
...
{
  var _Constructor = _vue.default.extend(_button5.default); //使用基础 Vue 构造器，创建一个“子类”
...
// 测试 图标应该默认在左边，也就是 order:1
{
  ...
  var _Constructor2 = _vue.default.extend(_button5.default); //使用基础 Vue 构造器，创建一个“子类”
...
// 测试 图标设置在右边，也就是 order:2
{
  ...
  var _Constructor3 = _vue.default.extend(_button5.default); //使用基础 Vue 构造器，创建一个“子类”
...
{
  // mock
  var _Constructor4 = _vue.default.extend(_button5.default); //使用基础 Vue 构造器，创建一个“子类”
